...
function GameMatrix({ 
  ...
  const getCellStyle = (roundIdx, playerIdx, cell) => {
    ...
    if (isFutureRound) {
      ...
      if (cell.success) {
        ...
        color = '#fff';  // White text for successful bets
      } else if (cell.score !== null) {
        backgroundColor = matrixColors.cell_failed;
        color = '#0a0e27';  // Black text for failed bets
      } else {
  ...
  // Debug logging
  console.log('GameMatrix Debug:', {
    mode,
    currentRound: game.current_round,
    totalRounds: game.total_rounds,
    isLastRound: game.current_round === game.total_rounds,
    hasFinishHandler: !!onFinishGame
  });
    ...
    <div className="game-matrix-container">
      <div className="matrix-controls">
        ...
        <div className="mode-indicator">
          {mode === 'bets' ? 'Bet Entry' : 'Mark Success/Fail (double-click)'}
        </div>
      </div>
